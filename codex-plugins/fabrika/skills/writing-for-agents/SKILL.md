...
> Imported verbatim from [`mattpocock/skills`](https://github.com/mattpocock/skills),
> `skills/productivity/writing-for-agents/`, MIT licensed (Copyright (c) 2026 Matt Pocock).
> See [`LICENSE`](LICENSE). Body text is upstream's; only this note is ours. Re-sync by
