...
UI keys off `error.code`, never the message string — the codes are the shared contract with the server's `WireCode` annotations ([fate-effect-wire-errors.md](./fate-effect-wire-errors.md)).
