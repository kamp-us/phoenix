...
| [token-economics-context-mode-eval.md](./token-economics-context-mode-eval.md) | The adopt/reject eval of the external [`mksglu/context-mode`](https://github.com/mksglu/context-mode) MCP+hooks plugin as a token lever: what it is, the verdict (reject on current evidence — cost-axis mismatch with our resident-scaffolding floor), why §2 before/after wasn't obtainable in-lane, the measurement that would reopen it | Considering context-mode (or a similar MCP context-saver) as a token lever ([#1356](https://github.com/kamp-us/phoenix/issues/1356) / [#1372](https://github.com/kamp-us/phoenix/issues/1372)) |
