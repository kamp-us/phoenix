...
| [fabrika-config-key-groups.md](./fabrika-config-key-groups.md) | Node tooling / CI | Adding or changing a `.fabrika.jsonc` key, deciding whether a machine may set it in `.fabrika.local.jsonc`, or reading one from a fabrika verb (epic [#5631](https://github.com/kamp-us/phoenix/issues/5631)) |
