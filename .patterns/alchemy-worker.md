...
- **Alchemy's integrated Vite source** now accepts bindings and DO namespaces (`alchemy@2.0.0-beta.77`, `lib/Cloudflare/Workers/Sources/Vite.js`). Phoenix keeps its separate Vite/Effect-worker processes; hosting this worker class entry through integrated Vite has not been verified.
