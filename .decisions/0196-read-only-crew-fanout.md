...
Fixes #3543 (the read-only-fanout crew-topology decision). Follow-up implementation tracked in #3597. Reconciled with #3534 (shared roster-law boundary; decided coherently).
