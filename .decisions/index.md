...
| [0054](0054-run-evidence-bundle.md) | Run-evidence bundle — the auto-merge gate trusts a SHA-bound structured run bundle, not prose; commit to the bundle contract, reuse CI as producer, defer crabbox/coordinator-DO (never build what you can install) | proposed | 2026-06-14 |
