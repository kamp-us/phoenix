...
| [0059](0059-ship-it-gating-check-set.md) | ship-it gates on the gating-check set, not the full rollup; preview deploys are informational (denylist of known-informational checks, fail-safe to blocking; consistent-by-construction with the run-evidence bundle) | accepted | 2026-06-15 |
