...
| [0054](0054-run-evidence-bundle.md) | Run-evidence bundle — the auto-merge gate trusts a SHA-bound structured run bundle, not prose; the bundle *contract* is settled, the *producer* is gated on a crabbox spike (crabbox leading, CI-emits-bundle fallback, native DO last resort) | proposed | 2026-06-14 |
