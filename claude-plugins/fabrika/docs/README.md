...
| [agent shells](agent-shells.md) | what an agent shell in [`../agents/`](../agents/) is, its three-field shape, the noun-naming rule and bare-noun address, the shell roster, the no-`memory:` and no-`effort:` rules, the model rule, the spawn-tool baseline, and the fields a plugin-scope shell may not use | #5586, #5617, #7019 |
