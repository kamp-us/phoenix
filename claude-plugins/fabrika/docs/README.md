...
| [hook surface](hook-surface.md) | where a fabrika hook is declared ([`../hooks.json`](../hooks.json)) and how it invokes a verb, and the record format every grading child writes into | #5074, #5076, #7020 |
| [hook records](hook-records.md) | the graded records for that surface — one recorded verdict per graded v1 piece plus the proven/unproven account of the delivery channel | #5076, #7020 |
