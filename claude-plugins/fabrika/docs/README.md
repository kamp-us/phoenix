...
| [the v1 cost baseline](cost-baseline.md) | the reproducible method behind the committed baseline the phase-1 cost ceiling is measured against — the run site, the v1-arm adapter, which pin comes from where, and the comparison surface | #4679 |
