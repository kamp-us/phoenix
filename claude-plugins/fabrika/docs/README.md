...
| [agent shells](agent-shells.md) | what an agent shell in [`../agents/`](../agents/) is, why there are exactly three, the no-`memory:` ruling, the model allowlist, and the rule that a shell which grows opinions is a defect | #5586 |
