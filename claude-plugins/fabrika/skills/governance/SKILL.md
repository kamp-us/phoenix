...
and this clone's branch refs, because a tree-local read structurally cannot see a sibling branch —
...
open ADR pull requests and this clone's own branches claim (`adr next`).
