 ...
 * session file.
 *
 * The host is `@kampus/tuval-pi/testing/faux`'s, shared with the vertical proof: Pi's own `fauxProvider`, so
...
import {PI_SESSION_PROGRAM, piSessionProgram} from "@kampus/tuval-pi";
import {
	FAUX_MODEL,
	...
	fauxText,
	fauxToolCall,
} from "@kampus/tuval-pi/testing/faux";
import {
	agentRoutes,
	windowProgram,
	windowRoutes,
