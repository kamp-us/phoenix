...
import {SessionList, SessionTranscriptView} from "@kampus/tuval-ui/agent-window";
import type {TranscriptAnswer} from "@kampus/tuval-ui/session-transcript";
import {bareSession, claudeSession, NOW} from "@kampus/tuval-ui/testing/agent-window";
