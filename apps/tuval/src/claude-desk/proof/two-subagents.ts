 ...
 * that overlapped (`packages/tuval-claude/src/history/fixtures/PROVENANCE.md`). Replaying it through the scripted `AgentSdk`
...
import {loadFixture} from "@kampus/tuval-claude/testing/history-fixtures";
import type {SDKMessage} from "@kampus/tuval-claude/testing/scripted-query";
import {type ScriptedSdk, scriptedSdk} from "@kampus/tuval-claude/testing/scripted-query";
