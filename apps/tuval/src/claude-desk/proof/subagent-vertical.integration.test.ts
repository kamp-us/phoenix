 ...
 * (`packages/tuval-claude/src/history/fixtures/two-subagent-turn.json`). The substitution is the SDK seam and nothing else
...
import {claudeChatWindow} from "@kampus/tuval-claude/window";
import type {
	AiAgentSessionMsg,
	AiAgentSessionState,
