...
export const sozluk = {
	...
	"search.palette.destinations.group": "kısayollar",
	"search.palette.destination.sozluk": "sözlük",
	"search.palette.destination.pano": "pano",
	"search.palette.destination.profile": "profilin",
	"search.palette.recent.group": "son aramalar",
	"search.palette.recent.description": "yeniden ara",
