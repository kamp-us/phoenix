 ...
 * the picker (`apps/tuval/src/shell/picker/entries.ts`); #7624 binds the window to that reference.
 */
 ...
 * `apps/tuval/src/shell/picker/open.ts` hands the process the window it was opened into as `CallingWindow`,
