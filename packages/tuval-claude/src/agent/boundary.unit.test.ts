/**
 * The boundary this directory keeps: the layer satisfies the generic service exactly, and the
 * layer's own requirement is one service the row provides. That the Agent SDK is named nowhere in
 * the desk app is the app's own check (`apps/tuval/src/claude-desk/agent-sdk.unit.test.ts`), since
 * this package cannot walk the app.
 *
