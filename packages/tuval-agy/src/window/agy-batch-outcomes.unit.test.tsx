 ...
 * window in `@kampus/tuval-ui`, because that package may not reach a backend and this case needs agy's.
 */
...
import * as fixtures from "../ai-agent/transcript-fixtures.ts";
