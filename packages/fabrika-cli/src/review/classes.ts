 ...
 * `apps/web/src/` was one consumer's layout standing in for every repo's — so phoenix's second
 * runnable app raised no `ui` class and its pixels passed every gate unrendered (#7369). An empty
