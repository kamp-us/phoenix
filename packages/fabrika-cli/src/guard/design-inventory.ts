 ...
 * shipped `packages/design/src` primitives and render it as one curated-hybrid index.
 *
 ...
 * No TS AST is needed: the metadata schema is a tag vocabulary carried in the comment
...
/** The firewall predicate: the inventory artifact is the only admissible write target. */
