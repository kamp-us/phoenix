...
| `review-ui fetch` | validates the governed exact-head Actions artifact into reviewer-owned scratch; exit `13` returns a proven red render. See the [consumer and producer record](../../../.patterns/review-ui-localhost-ci-evidence.md#producer-record) |
