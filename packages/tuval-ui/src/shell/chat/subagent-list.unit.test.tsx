 ...
 * `./subagents.unit.test.ts`, and the row-level removal in `./rows.unit.test.ts`. The same list over
 * a captured Claude background spawn needs Claude's fixtures, so it lives in the app, beside
 * Claude's window (`subagent-list-capture.unit.test.tsx`).
 */
