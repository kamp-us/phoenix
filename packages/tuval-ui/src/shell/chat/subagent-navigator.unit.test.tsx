 ...
 * the app's `shell/core/machine.unit.test.ts`; what is proven here is the other end of it, where the
 * key lands. That the page keeps one keydown listener, the desk's, is the app's to prove too
 * (`chat/keydown-listeners.unit.test.ts`), because the desk is the app's.
 *
