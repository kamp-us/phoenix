 ...
 * `./subagents.unit.test.ts`. Codex's native slots through this navigator need Codex's own fold, so
 * that case lives in the app, beside Codex's window (`native-subagent-view.unit.test.tsx`).
 */
 ...
 * (`apps/tuval/src/chat/chat-window.unit.test.tsx` carries the same shim and the #8174 case behind it).
 */
