 ...
 * rule needs: `apps/tuval/src/shell/ui/tokens.css` gates the ring on `[data-input-modality="keyboard"]`.
 *
 ...
 * asserted from three files, `apps/tuval/src/shell/ui/Desk.tsx`). React's capture handlers run at the root container
