 ...
 * them on screen. That the backend rows' declared reference resolves to this renderer through the
 * page's own inspector table needs the app's rows and table, so it is proven in the app
 * (`page/ai-agent-inspector-ref.unit.test.tsx`).
 */
