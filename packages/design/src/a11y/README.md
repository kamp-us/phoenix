# Property-based a11y — the promotion loop over the `@kampus/design` primitives
...
It generates randomized **valid** prop combinations for each `@kampus/design` primitive with
