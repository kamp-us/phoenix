 ...
 * import.
 *
 * `./notify.ts` puts this on the row and never sees React; `./window.tsx` is what the string names
 ...
 * module that declared the row** (#8262), not from the app — so `@kampus/tuval-notify` has to be
