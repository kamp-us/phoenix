 ...
 * declared dependency of `@kampus/tuval-pi` — it arrives only under `pi-client`. What that buys is a
 * generic delta format; what this package needs is a delta over its own `SessionSnapshot`, which is one
